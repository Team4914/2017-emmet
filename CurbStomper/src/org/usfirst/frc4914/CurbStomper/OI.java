...
public class OI {
    ...
    public OI() {
        ...
        // X.whenPressed(new ClimbStop());
        X.whenPressed(new LoadingDistance());
        ...
        START.whenPressed(new CentreTarget());
        
        SELECT = new JoystickButton(primaryJoystick, 7);
        SELECT.cancelWhenPressed(new CentreTarget());
        ...
        SmartDashboard.putData("Centre Target", new CentreTarget());
        SmartDashboard.putData("Distance Target", new DistanceTarget());
        SmartDashboard.putData("Climb Auto Stop", new ClimbStop());
        SmartDashboard.putData("Invert Drive", new InvertDrive());
        SmartDashboard.putData("Run Intake", new RunIntake());
        SmartDashboard.putData("Toggle Climb", new ClimbStop());
        SmartDashboard.putData("Reverse Climb", new ReverseClimb());
    }
